 ...
 * 
 */
@WebServiceClient(name = "StorageService", targetNamespace = "http://ws.soap.storageservice.lifecoach/", wsdlLocation = "https://virtual-lifecoach-storage.herokuapp.com/ws/storage?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STORAGESERVICE_QNAME = new QName("http://ws.soap.storageservice.lifecoach/", "StorageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://virtual-lifecoach-storage.herokuapp.com/ws/storage?wsdl");
    ...
    public Storage getStorageImplPort() {
        return super.getPort(new QName("http://ws.soap.storageservice.lifecoach/", "StorageImplPort"), Storage.class);
    }
    ...
    public Storage getStorageImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.soap.storageservice.lifecoach/", "StorageImplPort"), Storage.class, features);
    }
